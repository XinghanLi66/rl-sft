#!/bin/bash
# bash scripts/train/training_7b_dsr_sub_online.sh
set -x
...
python3 -m verl.trainer.main_ppo \
 ...
 actor_rollout_ref.model.path='/homes/gws/lxh22/models/Qwen2.5-Math-7B' \
 ...
 trainer.experiment_name='Qwen2.5-Math-7B-dsr_sub_online_0805'\
 ...
 trainer.total_epochs=200 2>&1 | tee 7b_dsr_sub_online.log