#!/bin/bash
# bash scripts/train/training_1.5b_dsr_sub_online.sh
set -x
...
python3 -m verl.trainer.main_ppo \
 ...
 trainer.experiment_name='Qwen2.5-Math-1.5B-dsr_sub_online_0805'\
 ...
 trainer.total_epochs=200 2>&1 | tee 1.5b_dsrsub_online.log