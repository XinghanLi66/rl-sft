#!/bin/bash
# bash scripts/train/training_1.5b_pi1_r128_offline.sh
set -x
...
python3 -m verl.trainer.main_ppo \
 ...
 trainer.experiment_name='Qwen2.5-Math-1.5B-pi1_r128_nobalancebatch'\
 ...
 trainer.total_epochs=200 2>&1 | tee verl_demo_pi1r128.log